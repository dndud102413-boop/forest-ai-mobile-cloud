...
python_version: "3.12"
pinned: false
short_description: 위치/사진 기반 산림 수종 추천 AI (임상도·DEM·산악기상 실측)
---

<!-- 위 YAML은 Hugging Face Spaces 배포용 설정입니다(GitHub·Streamlit Cloud는 무시).
     HF 배포 절차는 HUGGINGFACE_DEPLOY.md 참고. -->
